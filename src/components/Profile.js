  ...
  return (
    <React.Fragment>        
        ...
        <section className='d-flex justify-content-between my-2'>
            <label>+91 |{element.UserName}</label>
        ...
        <span className='col-md-6 pe-3 my-2'>
            ...
            <input className='_form-control text-capitalize' value={element.Name} placeholder='Enter First Name'/>
        </span>
        <span className='col-md-6 my-2'>
            <label className='_text-muted'>Last Name*</label>
            <input className='_form-control text-capitalize' value={element.LastName} placeholder='Enter Last Name'/>
        </span>
        </section>
        <section className='row my-2'>
        <span>
            <label className='_text-muted'>Email (Optional)</label>
            <input className='_form-control w-100 text-lowercase' value={ element.Email} placeholder='Enter Email Address'/>
        </span>
        </section>
